...
class Realteo {
	...
	public function init_plugin() {
		...
		include( 'paid-properties/class-realteo-paid-subscriptions.php' );

		if ( class_exists( 'WC_Product_Subscription' ) ) {
			
			include_once( 'paid-properties/class-realteo-paid-subscriptions-product.php' );
			include_once( 'paid-properties/class-wc-product-property-package-subscription.php' );
