...
$template_loader = new Realteo_Template_Loader; ?>
	...
	<div class="row margin-bottom-30">
		<div class="col-md-12">
			...
			<div class="input-with-icon grey"><i class="sl sl-icon-note"></i><input type="submit" name="edit_property" class="button realteo-button-edit-listing" value="<?php esc_attr_e( 'Edit property', 'realteo' ); ?>" /></div>
