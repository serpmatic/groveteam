				...
				<div class="col-md-12">
					...
					<div class="main-search-container">
						...
						<form action="<?php echo get_post_type_archive_link( 'property' ); ?>" class="main-search-form">
							...
							$any_status = get_option('realteo_home_search_any_status');
							?>
							...
							<div class="search-type">
								...
								foreach ($offer_types as $key => $value) {
									...
									if ($any_status && $i == 0) { ?>
        								<label class="active"><input  class="first-tab" name="_offer_type" checked="checked" value="<?php echo esc_attr($key); ?>" type="radio"><?php echo stripslashes(esc_html($value)); ?></label>
    								<?php } else { ?>
